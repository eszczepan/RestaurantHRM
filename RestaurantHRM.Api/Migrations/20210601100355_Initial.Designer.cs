...
namespace RestaurantHRM.Api.Migrations
{
    ...
    [Migration("20210601100355_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantHRM.Shared.Country", b =>
                {
            ...
            modelBuilder.Entity("RestaurantHRM.Shared.Employee", b =>
                {
            ...
            modelBuilder.Entity("RestaurantHRM.Shared.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RestaurantHRM.Shared.Employee", b =>
                {
                    b.HasOne("RestaurantHRM.Shared.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RestaurantHRM.Shared.JobCategory", "JobCategory")
                        .WithMany()
